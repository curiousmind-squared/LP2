            ...
            new KeyAdapter() {
                public void keyPressed (KeyEvent evt) {
                    if (evt.getKeyChar() == 'r') {
                        ...
                        figs.add(new Triangle(x1,y1, x2, y2, x3, y3, new int[] {rand.nextInt(101)+155, rand.nextInt(100), rand.nextInt(100)}, new int[] {rand.nextInt(101)+55, rand.nextInt(101)+55, rand.nextInt(101)+155}));
                    }
                        ...
                        figs.add(new Pentagono(x1, y1, x2, y2, x3, y3, x4, y4, x5, y5, new int[] {rand.nextInt(100), rand.nextInt(100), rand.nextInt(100)}, new int[] {rand.nextInt(101)+55, rand.nextInt(101)+55, rand.nextInt(101)+155}));
                    }                       
